...
AWS_LBC_CHART_VERSION="${AWS_LBC_CHART_VERSION:-1.13.4}"
EXTERNAL_SECRETS_CHART_VERSION="${EXTERNAL_SECRETS_CHART_VERSION:-0.18.2}"
ARGOCD_CHART_VERSION="${ARGOCD_CHART_VERSION:-8.1.2}"
